...
A fast, zero-dependency web tool that converts images into ASCII art right in your browser.
...
* **Drag & Drop Upload:** Drop any image file directly into the browser (recommended under 15 MB).
*  **Multiple Character Sets:** Switch between 4 distinct rendering styles:
  * **Detailed:** Wide tonal range for high-contrast images.
  * **Simple:** Minimalist character set for cleaner outlines.
  * **Binary:** Classic matrix-style `0` and `1` outputs.
  * **Blocks:** Unicode block elements (`█`, `▓`, `▒`, `░`) for dense shading.
